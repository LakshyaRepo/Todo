...
<html lang="en">
  ...
  <body>
   ...
   <div class="row">
    <div class="col-md-2"><h3 class="text-center"></h3>
  ...
  <a href ='<c:url value='/home'></c:url>' class="list-group-item list-group-item-action">View Todo</a>
   ...
   <div class="col-md-10">
   <c:if test="${page =='Home'}"><h3 class="text-center">All Todo's </h3>
   ...
   <c:if test="${page =='add'}"><h3 class="text-center"></h3><br>
   <form:form action="saveTodo" method="post"  modelAttribute="todo" >
    <div class="form-group">
    
    <form:input path="todoTitle" cssClass="form-control" placeholder="Title Of Todo"/>
